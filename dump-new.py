...
try:
	...
	pass
head = {"Mozilla/5.0 (Linux; Android 13) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.5735.196 Mobile Safari/537.36}
def logo():
	cmd('clear')
	print("""
    _    _              _  
...
\033[1;32m()=================================================
\033[1;32m(√) \033[1;33mCREATED BY   :  \033[1;33mMd Uzzal Hossain (🥀)
\033[1;32m(√) \033[1;34mON FACEBOK   : \033[1;34mMR.Uzzal🥀
\033[1;32m(√) \033[1;35mON GITHUB    :  \033[1;35mUzzal-Vau(🥀)
		...
		for fbuid in fbidz:
			...
			try:
				...
				if 'Ya' in oO:
					...
					os.system('rm -rf Hmm')
					print("\x1b[1;92m[UZZAL] Dumping UID From : " + fbuid)
				else:
					print("\x1b[1;92m[UZZAL] Dumping UID From : " + fbuid)
			except KeyError:
				print('\x1b[1;91m[UZZAL] Dumping UID From : ' + fbuid )
		apnd.close()
		print('\n\x1b[1;97m')
